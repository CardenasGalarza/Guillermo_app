...
if authentication_status:
    ...
    if selected == "SMSNV":
        ...
        xs = usernames = ['Cardenas', 'Hinostroza', 'Amedina', 'jbravob', 'Mauroar', 'Mbravo', 'Jmartinez']
    ...
    if selected == "Datacob":
        ...
        xs = usernames = ['Cardenas', 'avila20231', 'retamozo20231', 'vargas20231', 'epiquin20231']
        #xs = ['Cardenas', 'LLLERENAL', 'Hinostroza', 'Argomedo', 'VIERA']
        bs = (username in xs)
        ...
        if bs == True:
            ...
            #print(cuadromdf)
            cuadromdf = cuadromdf.iloc[:, [0,1, 2, 3,4] ]
